...
# Last review date: Wed Jul 09 16:41:01 UTC 2026
# -----------------------------------------------------------------------------------
...
if ! command -v java >/dev/null 2>&1; then
    ...
    apt update && apt install -y "$JAVA_PKG"
fi
...
# keytool -importcert -cacerts -storepass changeit -alias graylog_ca -file /etc/graylog/server/certs/graylog-ca.pem
if keytool -list \
