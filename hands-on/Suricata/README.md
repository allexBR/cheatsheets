...
```
cd /tmp && wget https://raw.githubusercontent.com/allexBR/cheatsheets/main/hands-on/Suricata/install-suricata.sh
```
```
...
> [!IMPORTANT]
> For more information on Remediations for Ntopng Flow Risks, please read:<br/>
